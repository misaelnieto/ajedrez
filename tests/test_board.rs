#[cfg(test)]
mod tests {
    use ajedrez::{ChessBoard, Color, DEFAULT_KING_COL, DEFAULT_KINGSIDE_ROOK_COL, DEFAULT_QUEENSIDE_ROOK_COL, Piece, PieceType, Square};
    ...
    fn test_castling() {
        ...
        let castling = board
            .set_piece_0(0, DEFAULT_QUEENSIDE_ROOK_COL, Some(Piece{color: Black, piece_type: Rook, moves: 0 }))
            .set_piece_0(0, DEFAULT_KING_COL, Some(Piece{color: Black, piece_type: King, moves: 0 }))
            .set_piece_0(0, DEFAULT_KINGSIDE_ROOK_COL, Some(Piece{color: Black, piece_type: Rook, moves: 0 }))
            .set_piece_0(7, DEFAULT_QUEENSIDE_ROOK_COL, Some(Piece{color: White, piece_type: Rook, moves: 0 }))
            .set_piece_0(7, DEFAULT_KING_COL, Some(Piece{color: White, piece_type: King, moves: 0 }))
            .set_piece_0(7, DEFAULT_KINGSIDE_ROOK_COL, Some(Piece{color: White, piece_type: Rook, moves: 0 }))
            .get_castling(true)
        ;
    ...
    fn test_castling_white_piece_moved() {
        ...
        let mut castling = board
            .set_piece_0(7, DEFAULT_KINGSIDE_ROOK_COL, Some(Piece{color: White, piece_type: Rook, moves: 1 }))
            .set_piece_0(7, DEFAULT_QUEENSIDE_ROOK_COL, Some(Piece{color: White, piece_type: Rook, moves: 1 }))
            .set_piece_0(7, DEFAULT_KING_COL, Some(Piece{color: White, piece_type: King, moves: 1 }))
            .get_castling(true)
            ;
